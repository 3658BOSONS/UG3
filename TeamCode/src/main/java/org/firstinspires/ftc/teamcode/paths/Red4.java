...
public class Red4
{
    ...
    public Red4()
    {
        ...
        points1.add(new MovementPoint(3100, 800, Math.toRadians(-45), 50));
        ...
        points5.add(new MovementPoint(1200, 850, Math.toRadians(0),0));
        points5.add(new MovementPoint(1800, 850, Math.toRadians(0),25));
