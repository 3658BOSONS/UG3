...
@Autonomous(name="RedShooterOnly", group="red")
public class RedShooterOnly extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        MovementPoint point = new MovementPoint(1400, 300, 50); //making the point
        ...
        while(opModeIsActive() && timer.milliseconds() < 1500){
            bulk.tick(true, false);
            dt.track();
            double[] drive = aim.track(Positions.goalX, Positions.goalY, 1400, 300, 0, 0, 0);
