...
public class AutoAimer
{
    ...
    public double[] track(double targetX, double targetY, double dist, double angleOffset, double headingOffset, double angleIntercept){
        double[] dtValues = new double[4];
        ...
        double posX = dt.getPosition().x;
        double posY = Math.sqrt((distanceToGoal*distanceToGoal)-((posX - targetX) * (posX - targetX)));
